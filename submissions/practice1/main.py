...
class Country:
    ...
    def __add__(self, other):
        total_gold = self.gold + other.gold
        total_silver = self.silver + other.silver
        total_bronze = self.bronze + other.bronze
        return country(self.name, total_gold, total_silver, total_bronze)
